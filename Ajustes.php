    ...
    <div class="background-container">
        <div class="login-box">
            ...
            <form id="settingsForm" method="POST" action="">
                <div>
                    <input type="email" name="correo" placeholder="Ingrese su correo electrónico" value="<?php echo htmlspecialchars($usuario['correo']); ?>" required>
                </div>
                <div>
                    <input type="password" name="contrasena" placeholder="Ingrese nueva contraseña" required>
                </div>
                <div>
                    <input type="text" name="nombre" placeholder="Ingrese su nombre" value="<?php echo htmlspecialchars($usuario['nombre']); ?>" required>
                </div>
                <div>
